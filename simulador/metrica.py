...
class Metrica:
    ...
    def calcula_var(self):
        ...
        for rodada in range(1, self.n_rodadas+1):
            ...
            self.var_nq2[rodada] = (nq1_med - self.media_esp[2]) ** 2 / (self.fregueses_por_rodada - 1)
            self.var_nq1[rodada] = (nq2_med - self.media_esp[3]) ** 2 / (self.fregueses_por_rodada - 1)
            self.var_ns2[rodada] = (ns1_med - self.media_esp[4]) ** 2 / (self.fregueses_por_rodada - 1)
            self.var_ns1[rodada] = (ns2_med - self.media_esp[5]) ** 2 / (self.fregueses_por_rodada - 1)
