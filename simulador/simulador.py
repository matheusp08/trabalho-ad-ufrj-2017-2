...
class Simulador:
    ...
    def executar(self, n_rodadas, fregueses_por_rodada, rho, fase_transiente):
        ...
        if fase_transiente:
            rodada_atual = 1                     # rodada da fase transiente
            ...
            while tempo_ate_prox_chegada > 0 and fregues_executando is not None:
                ...
                if fregues_executando.tempo_restante <= tempo_ate_prox_chegada:
                    ...
                    # pois o mesmo agora saira do sistema, terminando sua execucao
                        ...
                        if fregueses_servidos_na_rodada == fregueses_por_rodada:
...
def main(argv):
    ...
    Simulador().executar(fregueses_por_rodada, n_rodadas, rho, fase_transiente)
